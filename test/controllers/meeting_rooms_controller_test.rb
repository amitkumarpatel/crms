...
class MeetingRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting_room" do
    assert_difference('MeetingRoom.count') do
      post meeting_rooms_url, params: { meeting_room: { floor_no: @meeting_room.floor_no, name: @meeting_room.name } }
    end
  ...
  test "should update meeting_room" do
    patch meeting_room_url(@meeting_room), params: { meeting_room: { floor_no: @meeting_room.floor_no, name: @meeting_room.name } }
